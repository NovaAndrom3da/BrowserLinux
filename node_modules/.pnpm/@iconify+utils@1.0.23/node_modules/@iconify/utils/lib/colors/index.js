...
exports.colorToString = exports.compareColors = exports.stringToColor = void 0;
...
function fromFunction(value) {
    ...
    switch (func) {
        ...
        case 'rgba': {
            ...
            if (hasPercengage !== isPercentage[1] ||
...
function stringToColor(value) {
    ...
    if (keywords_1.colorKeywords[value]) {
        // Keyword
        return { ...keywords_1.colorKeywords[value] };
    }
    // Test for '('
    if (value.indexOf('(') !== -1) {
        // function(colors)
